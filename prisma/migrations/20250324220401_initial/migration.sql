...
-- AddForeignKey
ALTER TABLE "Note" ADD CONSTRAINT "Note_dayNoteId_fkey" FOREIGN KEY ("dayNoteId") REFERENCES "DayNote"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Todo" ADD CONSTRAINT "Todo_dayNoteId_fkey" FOREIGN KEY ("dayNoteId") REFERENCES "DayNote"("id") ON DELETE SET NULL ON UPDATE CASCADE;
